...
{
    public class Auth_Services : BaseServices, IAuth_Services
    {
        ...
        public Auth_Services(IConfiguration configuration)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (request.avatar != null)
                    {
                        ...
                        {
                            var avatarFile = await HandleUploadImage.Upfile(request.avatar,$"TTLTSEDU/avatar{account.Id}");
